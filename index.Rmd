...
event_group_year %>% 
  ...
  e_title(text = "R Events Yearly Distribution", 
...
### Attendance in R Events per year
...
event_group_rsvp_year %>% 
  ...
  e_title(text = "R Events Yearly Attendance", 
          subtext = "RSVP Count", 
          sublink = "#",
          left = "left", top = 4
  ) %>%
...
months.df %>% 
  e_charts(month) %>%
  e_bar(serie = Events_Count) %>% 
  e_title(text = "R Events Monthly Distribution", 
          subtext = "Frequency of Events", 
          sublink = "#",
          left = "left", top = 4
  ) %>%
...
### Attendance in R Events per month
...
months.rsvpdf %>% 
  e_charts(month) %>%
  e_bar(serie = Attendees) %>% 
  e_title(text = "R Events Monthly Attendance", 
          subtext = "RSVP Count", 
          sublink = "#",
          left = "left", top = 4
  ) %>%
